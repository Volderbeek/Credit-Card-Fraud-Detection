...
* **Jupyter Notebook (Google Drive)**: `<TODO: Insert GDrive Notebook Link Here>`
* **Model Generation**: The machine learning model file (`model.pkl`) is generated by executing the training code cells inside the Jupyter notebook.

---

## 🛠️ Technology Stack

* **Backend Service**: Python 3.13, Flask API, Flask-CORS (Cross-Origin Resource Sharing)
* **Data Science & ML Core**: Scikit-Learn 1.9.0 (Random Forest Classifier), Pandas 3.0.3, NumPy 2.5.0
...
```text
├── backend/
│   ├── app.py                  # Flask server containing model loader and prediction API
...
├── model.pkl                   # Pickled Random Forest classifier (~182MB)
